...
def run_user_program():
    ...
    try:
        ...
        subprocess.Popen(['python', 'nmaptool.py'], cwd=r"C:\Users\ACER\OneDrive\Desktop\Algorithm")

    except Exception as e:

        print(f"Error running nmaptool.py: {e}")
...
def run_dirscan_program():
    ...
    try:
        ...
        subprocess.Popen(['python', 'dirscan.py'], cwd=r"C:\Users\ACER\OneDrive\Desktop\Algorithm")

    except Exception as e:

        print(f"Error running dirscan.py: {e}")
...
def admin_panel():
    ...
    run_user_program()  # Run nmaptool.py

    run_dirscan_program()  # Run dirscan.py
